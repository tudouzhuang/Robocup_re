...
void ssd1306_UpdateScreen(void) {
	...
	//#ifdef SSD1306_USE_I2C_DMA
	//
	//				 flag_dma = 0;
	//			   // HAL_I2C_Mem_Write_DMA(&SSD1306_I2C_PORT, SSD1306_I2C_ADDR, 0x40,1,&SSD1306_Buffer[SSD1306_WIDTH*up_cnt] , SSD1306_WIDTH);
	//			    flag_dma=__HAL_DMA_GET_FLAG(&hdma_i2c1_tx,DMA_FLAG_TC6);
	//				while(!flag_dma);
	//#else
	//				ssd1306_WriteData(&SSD1306_Buffer[SSD1306_WIDTH*up_cnt],SSD1306_WIDTH);
	//#endif
	#ifdef SSD1306_USE_DMA
	    if(flag_dma == 1){
					...
					ssd1306_WriteCommand(0xB0 + up_cnt);
					ssd1306_WriteCommand(0x00);
